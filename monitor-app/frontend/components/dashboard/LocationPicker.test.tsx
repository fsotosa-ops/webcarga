...
describe('LocationPicker', () => {
  ...
  it('busca locales existentes y los muestra como sugerencias', async () => {
    vi.mocked(locationsApi.list).mockResolvedValue({
      data: [{
        ...
        operation_type: 'RM', operational_status: 'ACTIVE', is_manual_override: false, is_origin: false,
  ...
  it('elegir una sugerencia también llama a onSelectLocation con el local completo, para poder leer su zona', async () => {
    const loc = {
      ...
      operation_type: 'RM', operational_status: 'ACTIVE' as const, is_manual_override: false, is_origin: false,
      created_at: null, updated_at: null,
    }
